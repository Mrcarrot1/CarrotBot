...
public class LevelingSlashCommands : ApplicationCommandModule
{
    ...
    [SlashCommand("addlevelrole", "Adds a role to be granted to a user when they reach a certain level.", false), SlashRequirePermissions(Permissions.ManageRoles), LevelingCommandAttribute, RequireLeveling]
    ...
    [SlashCommand("removelevelrole", "Removes a level from being granted at a certain level."), SlashRequirePermissions(Permissions.ManageRoles), LevelingCommandAttribute, RequireLeveling]
    ...
    [SlashCommand("enableleveling", "Enables leveling in this server.", false), SlashRequireUserPermissions(Permissions.ManageGuild), LevelingCommandAttribute, RequireLeveling(false)]
    ...
    [SlashCommand("disableleveling", "Disables leveling in this server.", false), SlashRequireUserPermissions(Permissions.ManageGuild), LevelingCommandAttribute, RequireLeveling]
    ...
    [SlashCommand("addnoxpchannel", "Blacklists a channel from earning XP.", false), SlashRequireUserPermissions(Permissions.ManageGuild), LevelingCommandAttribute, RequireLeveling]
    ...
    [SlashCommand("removenoxpchannel", "Removes a channel from the XP blacklist.", false), SlashRequireUserPermissions(Permissions.ManageGuild), LevelingCommandAttribute, RequireLeveling]
    ...
    [SlashCommand("setlevelupchannel", "Sets a channel to send all level-up messages in.", false), SlashRequireUserPermissions(Permissions.ManageGuild), LevelingCommandAttribute, RequireLeveling]
    ...
    [SlashCommand("removelevelupchannel", "Removes the channel all level-up messages are being sent to.", false), SlashRequireUserPermissions(Permissions.ManageGuild), LevelingCommandAttribute, RequireLeveling]
    ...
    [SlashCommand("addlevelupmessage", "Adds a message that will be displayed to a user who reaches a certain level.", false), SlashRequireUserPermissions(Permissions.ManageGuild), LevelingCommandAttribute, RequireLeveling]
    ...
    [SlashCommand("removelevelupmessage", "Removes a level up message from the list to be shown to users who reach a certain level."), SlashRequireUserPermissions(Permissions.ManageGuild), LevelingCommandAttribute, RequireLeveling]
    ...
    [SlashCommand("setxpcooldown", "Sets the XP cooldown in this server."), SlashRequireUserPermissions(Permissions.ManageGuild), LevelingCommandAttribute, RequireLeveling]
    ...
    [SlashCommand("setxpperlevel", "Sets the XP per level in this server."), SlashRequireUserPermissions(Permissions.ManageGuild), LevelingCommandAttribute, RequireLeveling]
    ...
    [SlashCommand("setxppermessage", "Sets the XP a user receives for sending one message."), SlashRequireUserPermissions(Permissions.ManageGuild), LevelingCommandAttribute, RequireLeveling]
    ...
    [SlashCommand("levelingsettings", "Shows the settings for leveling in this server."), LevelingCommandAttribute, RequireLeveling]
    ...
    [SlashCommand("resetlevels", "Resets XP and levels."), SlashRequireUserPermissions(Permissions.ManageGuild), LevelingCommandAttribute, RequireLeveling]
    ...
    [SlashCommand("resetlevelsettings", "Resets leveling settings to their defaults."), SlashRequireUserPermissions(Permissions.ManageGuild), LevelingCommandAttribute, RequireLeveling]
    ...
    [SlashCommand("setcumulativeroles", "Sets whether level-up roles should be cumulative(combine) or the default(replace)."), LevelingCommand, RequireLeveling, SlashRequireUserPermissions(Permissions.ManageGuild)]
